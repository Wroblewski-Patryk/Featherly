...
- 2026-03-24: SCL-030 in progress (documented DB-aware JSON translated search strategy and staged rollout plan; adopted first reusable locale JSON search helper in admin content base listing query).
